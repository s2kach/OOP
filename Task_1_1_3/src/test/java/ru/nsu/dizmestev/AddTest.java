...
class AddTest {
    ...
    @Test
    void testEquals() {
        Expression add1 = new Add(new Number(1), new Variable("x"));
        Expression add2 = new Add(new Number(1), new Variable("x"));
        Expression add3 = new Add(new Variable("x"), new Number(1));
